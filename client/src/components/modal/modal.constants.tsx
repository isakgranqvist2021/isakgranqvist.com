export const ModalText = () => {
	return (
		<>
			...
			<p>
				At isakgranqvist.com, accessible from https://isakgranqvist.com, one of
				...
				isakgranqvist.com and how we use it.
			</p>
			...
			<p>
				isakgranqvist.com follows a standard procedure of using log files. These
